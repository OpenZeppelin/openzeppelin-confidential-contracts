...
:saturatingAdd: pass:normal[xref:#FHESafeMath-saturatingAdd-euint64-euint64-[`++saturatingAdd++`]]
:saturatingSub: pass:normal[xref:#FHESafeMath-saturatingSub-euint64-euint64-[`++saturatingSub++`]]
...
:saturatingAdd-euint64-euint64: pass:normal[xref:#FHESafeMath-saturatingAdd-euint64-euint64-[`++saturatingAdd++`]]
:saturatingSub-euint64-euint64: pass:normal[xref:#FHESafeMath-saturatingSub-euint64-euint64-[`++saturatingSub++`]]
...
[.contract-item]
[[FHESafeMath-saturatingAdd-euint64-euint64-]]
==== `[.contract-item-name]#++saturatingAdd++#++(euint64 a, euint64 b) → euint64++` [.item-kind]#internal#
...
[.contract-item]
[[FHESafeMath-saturatingSub-euint64-euint64-]]
==== `[.contract-item-name]#++saturatingSub++#++(euint64 a, euint64 b) → euint64++` [.item-kind]#internal#

Subtract `b` from `a` saturating at zero on underflow. The returned value is `a - b` if
`a >= b`, otherwise 0.
...
== Other
:HandleAccessManagerNotAllowed: pass:normal[xref:#HandleAccessManager-HandleAccessManagerNotAllowed-bytes32-address-[`++HandleAccessManagerNotAllowed++`]]
...
==== `[.contract-item-name]#++_validateHandleAllowance++#++(bytes32) → bool++` [.item-kind]#internal#
...
[.contract-item]
[[HandleAccessManager-HandleAccessManagerNotAllowed-bytes32-address-]]
==== `[.contract-item-name]#++HandleAccessManagerNotAllowed++#++(bytes32 handle, address account)++` [.item-kind]#error#
