...
==== `[.contract-item-name]#++_unwrap++#++(address from, address to, euint64 amount) → euint64++` [.item-kind]#internal#

Internal logic for handling the creation of unwrap requests.
