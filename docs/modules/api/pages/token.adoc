...
:unwrapRequester: pass:normal[xref:#ERC7984ERC20Wrapper-unwrapRequester-euint64-[`++unwrapRequester++`]]
...
:inferredTotalSupply-: pass:normal[xref:#ERC7984ERC20Wrapper-inferredTotalSupply--[`++inferredTotalSupply++`]]
:maxTotalSupply-: pass:normal[xref:#ERC7984ERC20Wrapper-maxTotalSupply--[`++maxTotalSupply++`]]
:unwrapRequester-euint64: pass:normal[xref:#ERC7984ERC20Wrapper-unwrapRequester-euint64-[`++unwrapRequester++`]]
:_checkConfidentialTotalSupply-: pass:normal[xref:#ERC7984ERC20Wrapper-_checkConfidentialTotalSupply--[`++_checkConfidentialTotalSupply++`]]
...
* `++finalizeUnwrap(unwrapAmount, unwrapAmountCleartext, decryptionProof)++`
* `++decimals()++`
* `++rate()++`
* `++underlying()++`
* `++supportsInterface(interfaceId)++`
...
==== `[.contract-item-name]#++unwrap++#++(address from, address to, euint64 amount) → euint64++` [.item-kind]#public#
...
==== `[.contract-item-name]#++unwrap++#++(address from, address to, externalEuint64 encryptedAmount, bytes inputProof) → euint64++` [.item-kind]#public#
...
==== `[.contract-item-name]#++finalizeUnwrap++#++(euint64 unwrapAmount, uint64 unwrapAmountCleartext, bytes decryptionProof)++` [.item-kind]#public#

Fills an unwrap request for a given cipher-text `unwrapAmount` with the `cleartextAmount` and `decryptionProof`.
...
[.contract-item]
[[ERC7984ERC20Wrapper-unwrapRequester-euint64-]]
==== `[.contract-item-name]#++unwrapRequester++#++(euint64 unwrapAmount) → address++` [.item-kind]#public#
