...
NOTE: All contracts must set their respective co-processor configuration during construction (or initialization). This can be done automatically by inheriting contracts in https://github.com/zama-ai/fhevm/blob/e376d87f5c0699a2611ab4933b4767490c91f1cd/library-solidity/config/ZamaConfig.sol#L54-L73[`ZamaConfig`].
