...
- {ERC7984CustodianAccess}: An extension for ERC7984, which allows each account to add a custodian who is given access to their transfer and balance amounts.
